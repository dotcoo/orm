...
func Select(model interface{}, s *orm.SQL, columns ...string) bool {
	return DefaultORM.Select(model, s, columns...)
}

func Count(s *orm.SQL) int {
	return DefaultORM.Count(s)
}

func CountMySQL(s *orm.SQL) int {
...
func Update(model interface{}, s *orm.SQL, columns ...string) sql.Result {
	return DefaultORM.Update(model, s, columns...)
}

func Delete(model interface{}, s *orm.SQL) sql.Result {
